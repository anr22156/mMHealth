...
def features(df,PPG_norm):
    ...
    df['RDC'] = df.apply(lambda row: (delta_time(row['onset_valley_point_idx'], row['dicrotic_notch_idx']) / delta_time(row['onset_valley_point_idx'], row['offset_valley_point_idx'])), axis=1)
